...
(function() {
    ...
    const Pencil = window['@pencil/draft-compact-knot-pointer-belongings-from-profile-statement']['Pencil']
    const DraftFabrikk = window['@pencil/draft-compact-knot-pointer-belongings-from-profile-statement']['DraftFabrikk']

    // keep !
    let passThroughFromBottom = {}
    passThroughFromBottom['@pencil/draft-knot-pointer-belongings-from-profile-statement'] = {}
    // keep

    passThrough['@pencil/draft-knot-pointer-belongings-from-profile-statement'] = function (spawnedPointerBelongings, passThroughKnot) {
...
passThroughFromBottom['@pencil/draft-knot-pointer-belongings-from-profile-statement']['FIELD_OF_VIEW'] = FIELD_OF_VIEW
passThroughFromBottom['@pencil/draft-knot-pointer-belongings-from-profile-statement']['PROJECTION_CENTER_Y'] = PROJECTION_CENTER_Y
passThroughFromBottom['@pencil/draft-knot-pointer-belongings-from-profile-statement']['PROJECTION_CENTER_X'] = PROJECTION_CENTER_X

passThroughFromBottom['@pencil/draft-knot-pointer-belongings-from-profile-statement']['canvas'] = ctx
...
// keep
let knot1 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 * 0.7 /*  keep */, 1 * 0.4 /* keep */, 1 * /* keep */ 2)
...
// keep
window['@pencil/draft-knot-pointer-belongings-from-profile-statement'] = {
    passThrough: passThrough['@pencil/draft-knot-pointer-belongings-from-profile-statement'],
    passThroughFromBottom: passThroughFromBottom['@pencil/draft-knot-pointer-belongings-from-profile-statement']
}
// keep
